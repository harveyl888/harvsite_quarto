...
`deparse()` and `deparse1()` are base R functions that return unevaluated R expressions into strings.  Passing a function name to `deparse()` leads to a similar output, however any comments are removed from the output.
